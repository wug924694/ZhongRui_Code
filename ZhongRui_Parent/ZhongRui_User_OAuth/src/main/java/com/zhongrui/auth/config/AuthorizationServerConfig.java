...
class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public JwtAccessTokenConverter jwtAccessTokenConverter(CustomUserAuthenticationConverter customUserAuthenticationConverter) {
        ...
        KeyPair keyPair = new KeyStoreKeyFactory(
                keyProperties.getKeyStore().getLocation(),                          //证书路径 zhongrui.jks
                keyProperties.getKeyStore().getSecret().toCharArray())              //证书秘钥 zhongruiapp
                .getKeyPair(
                        keyProperties.getKeyStore().getAlias(),                     //证书别名 zhongrui
                        keyProperties.getKeyStore().getPassword().toCharArray());   //证书密码 zhongrui
